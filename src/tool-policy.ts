...
export function mergeTurnMetadata(session: Metadata, turn: Metadata): Metadata {
  ...
  for (const key of ["preset_id", "ops_agent_id", "agent_access_snapshot", "vault_scope", "plugin_id", "mcp_bindings", "skill_bindings", "workflow_binding", "delegation_context", "delegation_binding"]) {
